...
<section class="service-section">
    <div class="container">
        ...
        <div class="row">
            <?php 
            $stmt = $pdo->query("SELECT Designer_id, firstname, lastname, address, yearofexperience FROM interioirdesigner");
    ...
    <div class="lower_portion text-center p-3 bg-dark rounded-bottom shadow-sm">
       ...
       <a class="btn btn-outline-warning btn-sm px-3 py-1 rounded-pill" 
   href="booking.php?id=<?= $designer['Designer_id'] ?>">
